        ...
        {isModalOpen && (
          ...
          >
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4 overflow-y-auto">
              ...
              >
                <Dialog.Panel className="mx-auto max-w-4xl rounded-2xl bg-white dark:bg-gray-700 p-6 shadow-2xl overflow-y-auto max-h-[70vh]">
                  <div className="relative">
                    <button
                      onClick={() => setIsModalOpen(false)}
                      className="absolute -top-2 -right-2 rounded-full bg-gray-200 dark:bg-gray-900 p-2 hover:bg-gray-300 dark:hover:bg-gray-700 transition"
                    >
